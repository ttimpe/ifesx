...
let Line = (() => {
    ...
    let _text_color_decorators;
    let _text_color_initializers = [];
    ...
    var Line = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.text_color = __runInitializers(this, _text_color_initializers, void 0);
    ...
    (() => {
        ...
        _type_decorators = [(0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.INTEGER)];
        _text_color_decorators = [(0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.STRING)];
        _color_decorators = [(0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.STRING)];
        ...
        __esDecorate(null, null, _text_color_decorators, { kind: "field", name: "text_color", static: false, private: false, access: { has: obj => "text_color" in obj, get: obj => obj.text_color, set: (obj, value) => { obj.text_color = value; } }, metadata: _metadata }, _text_color_initializers, _instanceExtraInitializers);
