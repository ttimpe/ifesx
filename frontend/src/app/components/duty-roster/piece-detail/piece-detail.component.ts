                ...
                <p-card styleClass="shadow-sm border border-slate-200 rounded-xl overflow-hidden">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex flex-col gap-2">
                            <label class="text-sm font-medium text-slate-700">Tagesart Auswahl</label>
                        ...
                        <div class="flex flex-col gap-2">
                            <label class="text-sm font-medium text-slate-700">ED Nr (Einzeldienst)</label>
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <small class="text-slate-400">Format: HH:MM:SS</small>
                        </div>
                        ...
                        <div class="flex flex-col gap-2">
                            <label class="text-sm font-medium text-slate-700">Dienststückart</label>
                         ...
                         <div class="flex flex-col gap-2">
                            <label class="text-sm font-medium text-slate-700">Umlauf</label>
